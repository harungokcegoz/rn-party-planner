...
const ContactsInitializer: React.FC = () => {
  ...
  const initializeContacts = async () => {
    try {
      ...
      if (status === "granted") {
        ...
        Alert.alert("Success", "Mock contacts have been created.");
      } else {
  ...
  const handleCreateMockContacts = () => {
    initializeContacts();
    setShowDialog(false);
  };

  const handleUseOwnContacts = () => {
    setShowDialog(false);
  };
  ...
  return (
    <ConfirmationDialog
      isOpen={showDialog}
      onClose={handleUseOwnContacts}
      onConfirm={handleCreateMockContacts}
      title="Contact Setup"
      description="Do you want to create mock contacts or use your own?"
